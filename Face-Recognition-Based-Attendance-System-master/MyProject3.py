...
def CreatTk():
    ...
    quitWindow = tk.Button(windowTake, text="DeleteDetails", command=DeletUser  ,fg="red"  ,bg="cadet blue"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
...
def AdminUser():
    ...
    StudentWindow = tk.Button(windowAdminUser, text="Update Student Information", command=CreatTk  ,fg="red"  ,bg="yellow"  ,width=20  ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
    StudentWindow.place(x=650, y=300)
    FaceTrainWindow = tk.Button(windowAdminUser, text="Face Train", command=None  ,fg="red"  ,bg="yellow"  ,width=20  ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
    FaceTrainWindow.place(x=650, y=350)
    FaceDetectionWindow = tk.Button(windowAdminUser, text="Face Detection Sample", command=None  ,fg="red"  ,bg="yellow"  ,width=20  ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
    FaceDetectionWindow.place(x=650, y=400)
    MianAttendanceWindow = tk.Button(windowAdminUser, text="Start Attendance", command=None  ,fg="red"  ,bg="yellow"  ,width=20  ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
    MianAttendanceWindow.place(x=650, y=450)
    quiteWindow = tk.Button(windowAdminUser, text="Quite", command=None  ,fg="red"  ,bg="yellow"  ,width=20  ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
